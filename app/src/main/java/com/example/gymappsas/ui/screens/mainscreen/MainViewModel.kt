...
class MainViewModel @Inject constructor(
    ...
    init {
        viewModelScope.launch {
            ...
            completedWorkoutsFlow.collect { completedWorkouts ->
                ...
                _uiState.update { it.copy(isLoading = false, completedWorkoutsWeeklyCounter = weeklyCounter) }
            }
        }
    }
    ...
    private fun getWeeklyWorkoutCounter(workouts: List<CompletedWorkout>): Int {
        ...
        return workouts.count { it.completedDate.isAfter(startOfWeek.minusDays(1)) && it.completedDate.isBefore(endOfWeek.plusDays(1)) }
    }
}